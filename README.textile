...
* "principal" tells whether they main heading for the item, as specified by the BBC was the composer or performer (it varies).  The MusicBrainz ID also goes with this person.
